...
import { BikeIcon, TimerIcon, StarIcon, HeartIcon } from "lucide-react";
    ...
    >
      <div className="w-full space-y-3">
        <div className=" relative h-[136px] w-full">
          ...
          <div className=" absolute left-2 top-2 flex items-center justify-center gap-[2px] rounded-full bg-white px-2 py-[2px] text-black">
